...
export function buildLedgerbaseSystemPrompt(
  ...
  return [
    ...
    '- Ha a kérdés a feladatkategóriák felsorolásáról vagy azonosításáról szól (pl. "milyen kategóriák vannak", "melyik kategóriához tartozik X"), a listTaskCategories toolt hívd a runSql helyett, és ne hardcode-olt vagy kitalált kategórialistából válaszolj.',
    '</rules>',
    '',
    '<tools>',
    ...
    '- listTaskCategories: visszaadja az adatbázisban ténylegesen elérhető feladatkategóriákat (code, name, description). Kategória-alapú kérdésnél ezt hívd runSql helyett.',
    '</tools>',
    '',
    '<examples>',
